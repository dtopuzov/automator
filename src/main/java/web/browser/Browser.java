...
public class Browser {
    ...
    public Browser(WebSettings webSettings) throws Exception {
        ...
        switch (settings.browserType) {
            ...
            case BrowserType.FIREFOX:
                ...
                break;
            default:
                String message = String.format("Unsupported browser type: %s", settings.browserType);
    ...
    public void start() throws Exception {
        switch (settings.browserType) {
            case BrowserType.CHROME:
                ...
                if (this.settings.browserSize != null) {
                    options.addArguments(String.format("window-size=%sx%s",
                            this.settings.browserSize.getWidth(),
                            this.settings.browserSize.getWidth()));
                }
        ...
        if (settings.wait != null) {
            this.driver.manage().timeouts().implicitlyWait(settings.wait, TimeUnit.SECONDS);
        }
    }
    ...
    public WebElement find(By locator) {
        return this.find(locator, settings.wait);
    }
    ...
    public void click(By locator) {
        this.click(locator, settings.wait);
    }
}
